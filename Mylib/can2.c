...
void CAN2_RX0_IRQHandler(void)
{
    ...
    if (CAN_GetITStatus(CAN2,CAN_IT_FMP0)!= RESET) 
    {
        ...
        CAN_Receive(CAN2, CAN_FIFO0, &rx_message);  
			if(rx_message.StdId == CAN_BUS1_ZGYRO_FEEDBACK_MSG_ID)
			{
					ZGyroModuleAngle = -0.01f*((int32_t)(rx_message.Data[0]<<24)|(int32_t)(rx_message.Data[1]<<16) | (int32_t)(rx_message.Data[2]<<8) | (int32_t)(rx_message.Data[3]));
					//printf("rx_message is %d \n\r",ZGyroModuleAngle);
			}
    }
}
